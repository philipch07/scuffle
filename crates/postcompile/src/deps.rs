/// Some of the code here is from the `ui_test` crate, and some is from `trybuild`.
/// Mainly related to how dependencies are found & included in the build.
/// Both of which are licensed under the MIT license.
